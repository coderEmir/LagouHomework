...
var headerVNode = [(0, _snabbdom.h)('button#ranking', {
  on: {
    click: updateSort
  }
}, '综合排名'), (0, _snabbdom.h)('button#month', {
  on: {
    click: updateSort
  }
}, '月份'), (0, _snabbdom.h)('button#sales', {
  on: {
    click: updateSort
  }
}, '销量')];
...
function initListNode(array) {
  ...
  array.forEach(function (item) {
    var singleRowVNode = (0, _snabbdom.h)('div', [(0, _snabbdom.h)('span', item.ranking), (0, _snabbdom.h)('span', ' '), (0, _snabbdom.h)('span', item.month), (0, _snabbdom.h)('span', ' '), (0, _snabbdom.h)('span', item.sales)]);
...
function render(oldNode, newVNode) {
  var contentVNode = [].concat(headerVNode, _toConsumableArray(listVNode));
  newVNode = (0, _snabbdom.h)('div#app', contentVNode);
